/** NOTA: estos URLS deben ser cambiados y poner atención al HTTP Y HTTPs
...
export const PLCONNECT_SIGNOFF = 'https://plconnect.prensalibre.com/cerrar-sesion/'; // Dominio de PL para cerrar sesión
export const PLGETUSER_URL = 'http://plservices.prensalibre.com/auth/'; // PL Services para objetener al usuario
